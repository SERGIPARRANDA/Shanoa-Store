            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="detallesP" id="detallesP"
                            aria-describedby="helpId" placeholder="Añade una descripcion para el Producto" required>
                    </div>
                    <div class="mb-3">
                        <label for="cantidadP" class="form-label">Cantidad</label>
                        <input type="text" class="form-control" name="cantidadP" id="cantidadP"
                            aria-describedby="helpId" placeholder="Añade una cantidad para el producto" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <input type="hidden" name="Persona_idUsuarios" value="1">
                    <!-- Supongamos que el ID del admin es 1 -->
